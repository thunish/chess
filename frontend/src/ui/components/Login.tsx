    ...
    return(
        <div className=" space-y-8">
            <div className=" space-y-2 text-center text-white">
                <div className=" text-3xl font-bold tracking-tighter ">Welcome Back !</div>
            ...
            <div className=" flex justify-start flex-col items-start space-y-4 w-full ">
                <div className=" flex space-y-2 text-white flex-col w-full">
                    ...
                    <input type="text"  placeholder="Thunish....." className=" h-12 bg-gray-00 text-gray-950 rounded-xl w-full px-2 border-none focus:border-none"/>
                </div>
                <div className=" flex space-y-2 text-white flex-col w-full">
                ...
                <button className=" w-full h-12 bg-gray-900 text-white hover:bg-black rounded-full">Signin</button>
            </div>
        </div>
    )
}